...
const Index: NextPage = () => (
  <>
    ...
    <section id="home">
      <Container>
        <div className="absolute text-white top-1/2 transform -translate-y-1/2 text-center p-2 left-1/2 -translate-x-1/2 sm:p-0 sm:text-left sm:left-auto sm:translate-x-0">
